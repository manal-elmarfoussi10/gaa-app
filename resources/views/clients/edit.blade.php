            ...
            <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input name="marque" value="{{ old('marque', $client->marque) }}" placeholder="Ex: Peugeot" class="form-input w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent" />
                    </div>

                    <div>
                        <label class="block text-gray-700 mb-2 font-medium">Modèle du véhicule</label>
                        <input name="modele" value="{{ old('modele', $client->modele) }}" placeholder="Ex: 208" class="form-input w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent" />
                    </div>
