                        ...
                        <div class="radio-group">
                            <label class="radio-option">
                                ...
                                <div>
                                    ...
                                    <span style="font-size: 0.875rem; color: #6b7280;">Questions, support ou informations</span>
                                </div>
                            </label>
                            <label class="radio-option">
                                <input type="radio" name="type" value="demo">
                                <div>
                                    <strong>Demande de démonstration</strong><br>
                                    <span style="font-size: 0.875rem; color: #6b7280;">Découvrez nos fonctionnalités en live</span>
                                </div>
                            </label>
                            <label class="radio-option">
                                <input type="radio" name="type" value="partner">
                                <div>
                                    <strong>Devenir partenaire</strong><br>
                                    <span style="font-size: 0.875rem; color: #6b7280;">Opportunités de collaboration commerciale</span>
                                </div>
                            </label>
                        </div>
