        ...
        <div class="mb-8">
            ...
            <div id="section-prospect" class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4 hidden">
                ...
                <div>
                    ...
                    <textarea name="prospect_address" rows="3" class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:border-orange-300 focus:ring focus:ring-orange-200 focus:ring-opacity-50" placeholder="Adresse complète du prospect">{{ old('prospect_address') }}</textarea>
                </div>
            </div>
        </div>
