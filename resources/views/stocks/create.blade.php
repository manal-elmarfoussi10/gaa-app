    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
            <div class="mb-4 md:mb-0">
                ...
                <p class="text-gray-600 mt-2">Remplissez les informations ci-dessous pour ajouter un nouveau produit au stock</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="reference" class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-200 focus:border-orange-500" required>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="date" name="date" class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-200 focus:border-orange-500">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <button type="submit" class="btn-primary text-white px-8 py-3 rounded-lg font-medium flex items-center justify-center w-full sm:w-auto">
                            <i class="fas fa-plus-circle mr-2"></i> Ajouter le produit au stock
                        </button>
                    </div>
                </div>
            </form>
