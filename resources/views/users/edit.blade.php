    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 pb-6 border-b border-gray-200">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Mettez à jour les informations de {{ $user->first_name }} {{ $user->last_name }}</p>
            </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="first_name" value="{{ old('first_name', $user->first_name) }}" required class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 transition duration-150">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Nom *</label>
                            <input type="text" name="last_name" value="{{ old('last_name', $user->last_name) }}" required class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 transition duration-150">
                        </div>

                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Adresse Email *</label>
                            <input type="email" name="email" value="{{ old('email', $user->email) }}" required class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 transition duration-150">
                        </div>

                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Mot de passe</label>
                            <div class="relative">
                                <input type="password" name="password" placeholder="Laisser vide pour conserver le mot de passe actuel" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 transition duration-150">
                            ...
                            <p class="mt-1 text-xs text-gray-500">Remplissez uniquement si vous souhaitez modifier le mot de passe</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <select name="role" required class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 transition duration-150">
                                ...
                                <option value="client_service" {{ old('role', $user->role) == 'client_service' ? 'selected' : '' }}>Service client</option>
                                ...
                                <option value="planner" {{ old('role', $user->role) == 'planner' ? 'selected' : '' }}>Service Devis, commande et RDV</option>
                        ...
                        <div class="flex items-center mt-2">
                            <div class="flex items-center h-5">
                                <input id="is_active" name="is_active" value="1" type="checkbox" class="focus:ring-orange-500 h-4 w-4 text-orange-600 border-gray-300 rounded" {{ old('is_active', $user->is_active) ? 'checked' : '' }}>
                            </div>
